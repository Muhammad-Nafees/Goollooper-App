        ...
        <SafeAreaView>
            <View style={styles.container}>
                    ...
                    <View style={{ justifyContent: "center", alignItems: "center", marginTop: 18 }}>
                        ...
                        <View style={{ width: "90%", }}>
                            ...
                            <View style={{ marginTop: 18 }}>
                                <Text style={{ fontSize: pixelRatio * 4.5, color: secondaryColor, fontWeight: "500", textTransform: "capitalize", }}>Re-Enter-Password</Text>
                ...
                <View style={styles.loginbutton}>
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate("VerificationScreen")} style={{ width: "90%", }}>
                ...
                <View style={{ justifyContent: "center", alignItems: "center", marginTop: 18 }}>
                    <View style={{ flexDirection: "row", width: "37%", justifyContent: "space-between", alignItems: "center" }}>
                ...
                <View style={{ justifyContent: "center", alignItems: "center", marginTop: 14 }}>
                    ...
                    <View style={{ flexDirection: "row", marginTop: 14 }}>
                        ...
                        <TouchableOpacity onPress={() => navigation?.navigate("Loginscreen")}>
                            <Text style={{ color: primaryColor }}> Sign in </Text>
                        </TouchableOpacity>
                    </View>
                </View>
